...
function (_Component) {
  ...
  _createClass(Wizard, [{
    ...
    value: function render() {
      return _react["default"].createElement("div", null, this.props.activeStep);
    }
  }]);
...
var mapState = function mapState(_ref, _ref2) {
  ...
  return {
    activeStep: _react["default"].Children.map(children, function (Child) {
      return wizard[name] && wizard[name].step === Child.props.step ? _react["default"].cloneElement(Child, {
        wizard: name
      }) : null;
    }).filter(function (el) {
      return el !== null;
